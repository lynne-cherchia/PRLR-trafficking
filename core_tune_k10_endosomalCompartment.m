function dydt = core_tune_k10_endosomalCompartment(t,y,params )
...
% ***Tunes parameter k10, to explore the effects of internalized PRLR on
% signaling strength***
...
dydt(4,1) = k_5*PRLRJ2aS5Ac + k_5*iPRLRJ2aS5Ac - k5*S5Ac*PRLRJ2a - k5*iPRLRJ2a*S5Ac + k12*PPXpS5Ac - k13*S5Ac*pS5Ac + k_13*pS5AcS5Ac - k13*S5Ac*pS5Bc + k_13*S5AcpS5Bc + k10*PRLRJ2aS5AcSHP2 + k10_internal*iPRLRJ2aS5AcSHP2 + kdeg*deg_ratio*(PRLRJ2aS5Ac + PRLRJ2aS5AcSHP2) + kdeg*deg_ratio*(iPRLRJ2aS5Ac + iPRLRJ2aS5AcSHP2) - k17inA*S5Ac + k17outA*S5An.*Vratio;
dydt(5,1) = k_5*PRLRJ2aS5Bc + k_5*iPRLRJ2aS5Bc - k5*S5Bc*PRLRJ2a - k5*iPRLRJ2a*S5Bc + k12*PPXpS5Bc - k13*S5Bc*pS5Bc + k_13*pS5BcS5Bc - k13*S5Bc*pS5Ac + k_13*pS5AcS5Bc + k10*PRLRJ2aS5BcSHP2 + k10_internal*iPRLRJ2aS5BcSHP2 + kdeg*deg_ratio*(PRLRJ2aS5Bc + PRLRJ2aS5BcSHP2) + kdeg*deg_ratio*(iPRLRJ2aS5Bc + iPRLRJ2aS5BcSHP2) - k17inB*S5Bc + k17outB*S5Bn.*Vratio;
dydt(6,1) = k_9*PRLRJ2aSHP2 + k_9*iPRLRJ2aSHP2 - k9*PRLRJ2a*SHP2 - k9*iPRLRJ2a*SHP2 + k10*PRLRJ2aSHP2 + k10_internal*iPRLRJ2aSHP2 - k9*SHP2*SOCS1PRLRJ2a - k9*SHP2*iSOCS1PRLRJ2a + k_9*SOCS1PRLRJ2aSHP2 + k_9*iSOCS1PRLRJ2aSHP2 + k10*SOCS1PRLRJ2aSHP2 + k10_internal*iSOCS1PRLRJ2aSHP2 - k9*SHP2*PRLRJ2aS5Ac - k9*SHP2*iPRLRJ2aS5Ac + k_9*PRLRJ2aS5AcSHP2 + k_9*iPRLRJ2aS5AcSHP2 - k9*SHP2*PRLRJ2aS5Bc - k9*SHP2*iPRLRJ2aS5Bc + k_9*PRLRJ2aS5BcSHP2 + k_9*iPRLRJ2aS5BcSHP2 + k10*PRLRJ2aS5AcSHP2 + k10_internal*iPRLRJ2aS5AcSHP2 + k10*PRLRJ2aS5BcSHP2 + k10_internal*iPRLRJ2aS5BcSHP2 + kdeg*deg_ratio*(PRLRJ2aSHP2 + PRLRJ2aS5AcSHP2 + PRLRJ2aS5BcSHP2 + SOCS1PRLRJ2aSHP2) + kdeg*deg_ratio*(iPRLRJ2aSHP2 + iPRLRJ2aS5AcSHP2 + iPRLRJ2aS5BcSHP2 + iSOCS1PRLRJ2aSHP2) + k24*SOCS1PRLRJ2aSHP2 + k24*iSOCS1PRLRJ2aSHP2;
...
dydt(12,1) = k3*iPRLRJ*iRJ - k_3*iPRLRJ2 - k4*iPRLRJ2 + k10_internal*iPRLRJ2aSHP2 + k10_internal*iSOCS1PRLRJ2aSHP2 + k10_internal*iPRLRJ2aS5AcSHP2 + k10_internal*iPRLRJ2aS5BcSHP2 - kdeg*deg_ratio*iPRLRJ2 + kint_bound*PRLRJ2 - krec_bound*iPRLRJ2;
...
dydt(25,1) = k9*iPRLRJ2a*SHP2 - k_9*iPRLRJ2aSHP2 - k10_internal*iPRLRJ2aSHP2 + k23*iSOCS1PRLRJ2aSHP2 - kdeg*deg_ratio*iPRLRJ2aSHP2 + kint_bound*PRLRJ2aSHP2 - krec_bound*iPRLRJ2aSHP2;
...
dydt(53,1) = k20*mRNAc- k21*SOCS1*PRLRJ2a - k21*SOCS1*iPRLRJ2a + k_21*SOCS1PRLRJ2a + k_21*iSOCS1PRLRJ2a - k23*SOCS1 + k10*SOCS1PRLRJ2aSHP2 + k10_internal*iSOCS1PRLRJ2aSHP2 + kdeg*deg_ratio*(SOCS1PRLRJ2a + SOCS1PRLRJ2aSHP2) + kdeg*deg_ratio*(iSOCS1PRLRJ2a + iSOCS1PRLRJ2aSHP2);
...
dydt(57,1) = k9*SHP2*iPRLRJ2aS5Ac - k_9*iPRLRJ2aS5AcSHP2 - k10_internal*iPRLRJ2aS5AcSHP2 - kdeg*deg_ratio*iPRLRJ2aS5AcSHP2 + kint_bound*PRLRJ2aS5AcSHP2 - krec_bound*PRLRJ2aS5AcSHP2;
...
dydt(59,1) = k9*SHP2*iPRLRJ2aS5Bc - k_9*iPRLRJ2aS5BcSHP2 - k10_internal*iPRLRJ2aS5BcSHP2 - kdeg*deg_ratio*iPRLRJ2aS5BcSHP2 + kint_bound*PRLRJ2aS5BcSHP2 - krec_bound*PRLRJ2aS5BcSHP2;
...
dydt(61,1) = k9*SHP2*iSOCS1PRLRJ2a - k_9*iSOCS1PRLRJ2aSHP2 - k10_internal*iSOCS1PRLRJ2aSHP2 - k23*iSOCS1PRLRJ2aSHP2 - kdeg*deg_ratio*iSOCS1PRLRJ2aSHP2 - k24*iSOCS1PRLRJ2aSHP2 + kint_bound*SOCS1PRLRJ2aSHP2 - krec_bound*iSOCS1PRLRJ2aSHP2;
