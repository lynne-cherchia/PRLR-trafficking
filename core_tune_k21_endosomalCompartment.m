function dydt = core_tune_k21_endosomalCompartment(t,y,params )
...
% ***Tunes parameter k21, to explore the effects of internalized PRLR on
% signaling strength***
...
dydt(14,1) = k4*iPRLRJ2 - k5*iPRLRJ2a*S5Ac + k_5*iPRLRJ2aS5Ac + k6*iPRLRJ2aS5Ac - k5*iPRLRJ2a*S5Bc + k_5*iPRLRJ2aS5Bc + k6*iPRLRJ2aS5Bc - k9*iPRLRJ2a*SHP2 + k_9*iPRLRJ2aSHP2 - k21_internal*iPRLRJ2a*SOCS1 + k_21*iSOCS1PRLRJ2a + k23*iSOCS1PRLRJ2a - kdeg*deg_ratio*iPRLRJ2a + kint_bound*PRLRJ2a - krec_bound*iPRLRJ2a;
...
dydt(53,1) = k20*mRNAc- k21*SOCS1*PRLRJ2a - k21_internal*SOCS1*iPRLRJ2a + k_21*SOCS1PRLRJ2a + k_21*iSOCS1PRLRJ2a - k23*SOCS1 + k10*SOCS1PRLRJ2aSHP2 + k10*iSOCS1PRLRJ2aSHP2 + kdeg*deg_ratio*(SOCS1PRLRJ2a + SOCS1PRLRJ2aSHP2) + kdeg*deg_ratio*(iSOCS1PRLRJ2a + iSOCS1PRLRJ2aSHP2);
...
dydt(55,1) = k21_internal*SOCS1*iPRLRJ2a - k_21*iSOCS1PRLRJ2a - k9*SHP2*iSOCS1PRLRJ2a + k_9*iSOCS1PRLRJ2aSHP2 - k23*iSOCS1PRLRJ2a - kdeg*deg_ratio*iSOCS1PRLRJ2a - k24*iSOCS1PRLRJ2a + kint_bound*SOCS1PRLRJ2a - krec_bound*iSOCS1PRLRJ2a;
